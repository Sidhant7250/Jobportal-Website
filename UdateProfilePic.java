 ...
 * @author user
 */
public class UdateProfilePic  extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
       ...
       try
       {
                DiskFileItemFactory factary = new DiskFileItemFactory();
                ServletFileUpload sfu=new ServletFileUpload(factary);
       ...
       try
       {
         ...
         if(i>0)
         {
             session.setAttribute("session_pic", file_name);
             con.commit();
